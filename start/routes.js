...
const Route = use('Route')
  ...
  Route.group(() => {
    ...
    Route.group(() =>{
      ...
      Route.delete('/eliminarusuariobuque/:id', 'BuqueuserController.eliminarusuario')
      Route.get('/obtenerusuariobuque/:id', 'BuqueuserController.obtenerunusuario')
      Route.put('/editarusuariobuque/:id', 'BuqueuserController.editarusuario' )
    })
      .prefix('naviera')
      .middleware(['auth'])
